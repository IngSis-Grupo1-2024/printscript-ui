...
export const SnippetExecution = ({snippetRunningOutput=""}:{snippetRunningOutput: string}) => {
  ...
  const handleEnter = (event: { key: string }) => {
    ...
    useEffect(() => {
        if (snippetRunningOutput) {
            setOutput(snippetRunningOutput.split("\n"));
        }
    }, [snippetRunningOutput]);
